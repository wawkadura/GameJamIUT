...
class SceneLevelBoss3(GS.GameScene):
    def __init__(self, playerPos: sees.PosTuple):
        super().__init__(playerPos, (80, 16), (224, 16), (-16, -16), T.TileFacing.NORTH)
        self.level = "1-3-3"
        self._endframe = 0
        ...
        self.addGround((48,64))
        self.addWallBlock((48,80))
        self.addWallBlock((48,96))
        self.addWallBlock((48,112))
        self.addGround((48,128))
        self.addGround((48,144))
        self.addGround((48,160))
        self.addWallBlock((64,16))
        self.addWallBlock((64,32))
        self.addGround((64,48))
        self.addGround((64,64))
        self.addWallBlock((64,80))
        ...
        self.addWallBlock((224,32))
        self.addGround((224,48))
        self.addWallBlock((224,64))
        ...
        self.addDecoration((128,112), GS.DecoTypes.BUREAU_GAUCHE)

        self.addDecoration((192,0), GS.DecoTypes.ARMOIRE_FERMEE_HAUT)
        self.addDecoration((192,16), GS.DecoTypes.ARMOIRE_FERMEE_BAS)
        self.addDecoration((208,0), GS.DecoTypes.ARMOIRE_FERMEE_HAUT)
        self.addDecoration((208,16), GS.DecoTypes.ARMOIRE_FERMEE_BAS)
        self.addDecoration((176,0), GS.DecoTypes.AFFICHE_ROUGE)
        self.addDecoration((112,96), GS.DecoTypes.AFFICHE_ROUGE_PENCHEE)
        self.addDecoration((208,160), GS.DecoTypes.FLAQUE)
        self.addDecoration((48,64), GS.DecoTypes.FLAQUE)

        self.addDecoration((80,0), GS.DecoTypes.DOUBLE_PAPIER)
        self.addDecoration((48,0), GS.DecoTypes.DOUBLE_PAPIER)

        self.addDecoration((192,112), GS.DecoTypes.SIMPLE_PAPIER)
        self.addDecoration((208,48), GS.DecoTypes.SIMPLE_PAPIER)

        self.addDecoration((64,128), GS.DecoTypes.CARTONS)
        self.addDecoration((160,96), GS.DecoTypes.CARTONS)
        self.addDecoration((144,160), GS.DecoTypes.CARTONS)

        self.addDecoration((48,16), GS.DecoTypes.BUREAU_FACE)
        ...
        self.addWallBlock((160,16))
        self.addWallBlock((160,48))
        self.addWallBlock((176,48))
        self.addWallBlock((160,80))
        self.addWallBlock((176,80))

        self.addSecondaryCube((80,64))
        self.addSecondaryCube((176,160))

        self.addBarrierAndButton((224,48), (176,144), False)
        self.addBarrierAndButton((224,80), (176,32), True)
        self.addBarrierAndButton((224,96), (32,160), True)
        self.addBarrierAndButton((224,112), (16,32), False)
        self.addBarrierAndButton((224,144), (176,64), True)
        self.addBarrierAndButton((16,160), (16,112), False)
        self.addBarrierAndButton((64,96), (80,32), False)
        self.addBarrierAndButton((160,64), (80,80), False)
        self.addBarrierAndButton((160,32), (48,32), False)
        self.addAirCannon((128,80))
        self.addAirCannon((112,80))
        
        self.addEntryDoor((112,176),T.TileFacing.SOUTH)
        
        self._boss = E.EntityBoss1(self, (112, 16))
    ...
    def mapLogic(self):
        if self._door.getOpened() == True and self._endframe == 0:
            self.setInputs(None)
            Sound= pygame.mixer.Sound("SoundTrack/Accomplished_2.wav")
            Sound.play()
            self.musicOff()
            ...
            for cannon in self._aircannons:
                cannon.enableAir()
            self._endframe += 1
        if self._endframe > 0 and self._endframe < 180:
            self._endframe += 1
        if self._endframe == 30:
            self._boss.setPos((112, 8))
        if self._endframe == 60:
            self._boss.setPos((112, 0))
        if self._endframe == 90:
            self._boss.kill()
        if self._endframe == 180:
            self.setState(SceneState.CHANGE_SCENE)